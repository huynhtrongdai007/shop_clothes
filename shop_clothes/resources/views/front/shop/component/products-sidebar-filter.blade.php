    ...
    <div class="filter-widget">
        ...
        <div class="fw-tag-choose">
            <div class="sc-items">
                ...
                <label for="clothing" class="{{request ('tag') ==  'clothing' ? 'active' : ''}}">Clothing</label>
            </div>
            <div class="sc-items">
                <input type="radio" id="shoes" name="tag" value="shoes" onchange="this.form.submit();"
                    {{request ('tag') == 'shoes' ? 'checked':''}}>
                <label for="shoes" class="{{request ('tag') ==  'shoes' ? 'active' : ''}}">Shoes</label>
            </div>
            <div class="sc-items">
                <input type="radio" id="coat" name="tag" value="coat" onchange="this.form.submit();"
                    {{request ('tag') == 'coat' ? 'checked':''}}>
                <label for="coat" class="{{request ('tag') ==  'coat' ? 'active' : ''}}">Coat</label>
            </div>
            <div class="sc-items">
                <input type="radio" id="trousers" name="tag" value="trousers" onchange="this.form.submit();"
                    {{request ('tag') == 'trousers' ? 'checked':''}}>
                <label for="trousers" class="{{request ('tag') ==  'trousers' ? 'active' : ''}}">Trousers</label>
            </div>
            <div class="sc-items">
                <input type="radio" id="hat" name="tag" value="hat" onchange="this.form.submit();"
                    {{request ('tag') == 'hat' ? 'checked':''}}>
                <label for="hat" class="{{request ('tag') ==  'hat' ? 'active' : ''}}">Hat</label>
            </div>
            <div class="sc-items">
                <input type="radio" id="backpack" name="tag" value="backpack" onchange="this.form.submit();"
                    {{request ('tag') == 'backpack' ? 'checked':''}}>
                <label for="backpack" class="{{request ('tag') ==  'backpack' ? 'active' : ''}}">Backpack</label>
            </div>
