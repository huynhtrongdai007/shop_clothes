                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-5">
                            ...
                            <a href="#" class="primary-btn">Shop Now</a> I
                        </div>
                    </div>
                    <div class="off-card">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-latest-blog">
                        ...
                        <div class="latest-text">
                            ...
                            <p> Sed quia non numquam modi tepora indunt ut labore et dolore magnam aliquam quaerat</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <div class="single-benefit">
                            ...
                            <div class="sb-text">
                                <h6>Recure Payment</h6>
                                <p>100% recure payment</p>
                            </div>
                        </div>
                    </div>
                </div>
